...
***********************************************************/	
	...
	//Set Upload directory    
		$uploaddir = $_SERVER['DOCUMENT_ROOT'].'/BeSocial/src/img/profile_pics';
	//Set File name	
...
<div class="container">
		...
		<div class="col-md-12 bg-dark">
			...
			<div class="main_column column">
				<div id="formExample">
				    ...
				    <form action="upload.php" method="post" class="p-4 text-white" enctype="multipart/form-data">
				        Upload Your Profile Photo<br /><br />
				        <input required type="file" id="image" name="image" style="width:300px; height:30px; " /><br /><br />
				        <input type="submit" class="btn btn-success" value="Submit" style="width:85px; height:35px;" />
				    </form><br /><br />
    ...
    if($imgSrc){ //if an image has been uploaded display cropping area?>
	    ...
	    <div id="CroppingContainer" class="container" style="width:800px; max-height:600px; background-color:#FFF; position:relative; overflow:hidden; border:2px #666 solid; z-index:2001; padding-bottom:0px;">  
	        ...
	        <div id="CropImageForm" style="width:100px; height:30px; float:left; margin:10px 0px 0px 40px;" >  
	            <form action="upload.php" method="post" onsubmit="return checkCoords();">
	                ...
	                <input type="submit" class="btn btn-success" value="Save" style="width:120px; height:35px;"   />
	            </form>
	        </div>
	        ...
	        <div id="CropImageForm2" style="width:100px; height:30px; float:left; margin:10px 0px 0px 40px;" >  
	            <form action="upload.php" method="post" onsubmit="return cancelCrop();">
	                <input type="submit" class="btn btn-danger" value="Cancel Crop" style="width:120px; height:35px;"   />
	            </form>
	        </div>            
